...
class Wall: 
    def __init__(self, x, y): 
        self.x, self.y = x, y 
        self.pic = pg.image.load("C:/Users/oneta/pp2/pp2-22B050836/2.png") 
...
s = Snake() 
f = Food(pg.image.load(f'C:/Users/oneta/pp2/pp2-22B050836/coin2.jpg')) 
disappear(5000) 
...
while is_running: 
    ...
    my_walls = open(f'C:/Users/oneta/pp2/pp2-22B050836/tsis10/wall1.txt', 'r').readlines()  
    walls = [] 
